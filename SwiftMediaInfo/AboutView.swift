...
struct AboutView: View {
    ...
    var copyrightText: String {
        ...
        if currentYear == startYear {
            return "© \(startYear) Undisclosed / Data Lass"
        } else {
            return "© \(startYear)–\(currentYear) Undisclosed / Data Lass"
        }
    }
        ...
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                VStack(spacing: 6) {
                    ...
                    Button {
                        if let url = URL(string: "https://github.com/Undisclosed0369/SwiftMediaInfo/blob/main/LICENSE") {
                            NSWorkspace.shared.open(url)
                        }
                    } label: {
